...
//   commissions,
// }) => {
//   const commissionArray = Array.isArray(commissions) ? commissions : [];
//   const stats = [
...
//       value: commissionArray.reduce((sum, c) => sum + c.amount, 0),
//       color: "#2196F3",
//     },
//   ];
...
const TotalUserAgent = () => {
  return (
    <div>
      This is a placeholder for the TotalUserAgent component.
    </div>
  );
};
