...
// import { useGetAllCommissionQuery } from "@/redux/features/admin/admin.api";
...
//   const { data: adminData, isLoading: isAdminLoading } = useGetAllCommissionQuery(undefined);
  
//   const { data: AgentData, isLoading: isAgentLoading } = useGetCommissionQuery(undefined);
