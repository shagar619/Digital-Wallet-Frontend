...
// import { useGetYourWalletQuery } from "@/redux/features/user/user.api";
...
//   const { data: adminData, isLoading: isAdminLoading } = useGetAllWalletQuery(undefined);
//   const { data: userData, isLoading: isUserLoading } = useGetYourWalletQuery(undefined);
