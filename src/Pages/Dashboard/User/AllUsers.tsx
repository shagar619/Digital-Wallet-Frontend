...
import { useGetAllAgentQuery, useGetAllUserQuery } from "@/redux/features/admin/admin.api";
...
const AllUsers = () => {
  ...
  const { data: agentData, isLoading: isAgentLoading } = useGetAllAgentQuery(undefined);
